...
module "Foo_LambdaEdge_Fn" {
  /* Foo_LambdaEdge_Fn module inputs */
}

module "AWS_CloudFront" {
  source = "git@github.com:Nerdware-LLC/fixit-cloud-modules.git//AWS_CloudFront"
  ...
  cache_behaviors = [
    # The index-0 cache behavior serves as the distribution's default cache behavior
    {
      ...
      lambda_edge_associations = {
        module.Foo_LambdaEdge_Fn.Function.arn = {
